...
!(function () {
  ...
  function X(e) {
    ...
    if ("touchstart" === a.type) return void R(t, a, a.targetTouches[0].pageX);
    ...
    function (e) {
      ...
      function P() {
        ...
        t.params.uniqueNavElements &&
          ...
          a &&
            ((r = a.querySelector(ae(t.params.scrollbar.dragClass))),
    ...
    function (e) {
      ...
      const a = (e, s) => {
        ...
        i || (i = me("flip", e, t.isHorizontal() ? "left" : "top")),
          a || (a = me("flip", e, t.isHorizontal() ? "right" : "bottom")),
  ...
  function ve(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : ge(t[s]) && ge(e[s]) && Object.keys(t[s]).length > 0
          ? t[s].__swiper__
            ? (e[s] = t[s])
            : ve(e[s], t[s])
          : (e[s] = t[s]);
  ...
  function xe(e, t, s) {
    ...
    return (
      "string" == typeof t &&
        void 0 !== s &&
        l.push({ name: t, value: ge(s) ? { ...s } : s }),
      l.forEach((e) => {
        const t = ye.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const s = we(t),
            i = we(e.name.split(`${t}-`)[1]);
          void 0 === a[s] && (a[s] = {}),
            !0 === a[s] && (a[s] = { enabled: !0 }),
            (a[s][i] = be(e.value));
        } else {
  ...
  class Ce extends Se {
    ...
    initialize() {
      ...
      this.initialized = !0;
      const { params: t, passedParams: s } = xe(this);
      (this.swiperParams = t),
        (this.passedParams = s),
        delete this.swiperParams.init,
        this.render(),
        (this.swiper = new se(this.shadowRoot.querySelector(".swiper"), {
          ...(t.virtual
            ? {}
    ...
    updateSwiperOnPropChange(e, t) {
      const { params: s, passedParams: i } = xe(this, e, t);
      (this.passedParams = i),
        (this.swiperParams = s),
  ...
  "undefined" != typeof window &&
    ...
    "undefined" != typeof window &&
      (window.customElements.get("swiper-container") ||
        window.customElements.define("swiper-container", Ce),
      window.customElements.get("swiper-slide") ||
        window.customElements.define("swiper-slide", Pe));
})();
